...
in_directory = "data/raw_data/doi-10.5064-f6l9hhyl"
out_individual = "data/processed_transcripts/doi-10.5064-f6l9hhyl"
out_combined = "data/combined_transcripts/doi-10.5064-f6l9hhyl__combined_transcripts.csv"
...
def collect_input_pdf_filenames(directory):
    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            if file.endswith(".pdf") and"Characteristic" not in file and "Data" not in file and "Ethics" not in file and "Lily" not in file and "Patrick" not in file and "Political" not in file:
