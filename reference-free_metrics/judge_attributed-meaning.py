...
Rate the level of attributed meaning of the participant statement from in the current interview excerpt below on a scale from 1 to 3. In addition to the current excerpt, you are also provided with a short context blurb and the interview excerpt that immediately preceded the current excerpt in the transcript. These two sections are only to understand the context of the current excerpt, and your rating should be for participant statement in the current excerpt.

Scoring Rubric:
1. The participant statement does not provide information indicating how significant an action or experience is to the participant.
2. The participant statement indicates some level of significance of an action or experience to a participant but does not provide information about what that significance is.
3. The participant statement directly shows the significance of an action or experience to the participant and explains what that significance is.
...
def main():
    ...
    parser.add_argument("--output-dir", default="data/reference-free_metrics/attributed-meaning", help="Directory to write outputs")
