...
Scoring Rubric:
1. The participant statement is generic or abstract, providing only high-level summaries or vague descriptions.
2. The participant statement describes a particular event, action, or opinion without concrete details or examples.
3. The participant statement describes a particular event, action, or opinion with concrete details or examples.
...
def main():
    ...
    parser.add_argument("--output-dir", default="data/reference-free_metrics/specificity", help="Directory to write outputs")
