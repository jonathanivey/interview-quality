    ...
    for csv_file in csv_files:
        ...
        with csv_file.open("r", encoding="utf-8", newline="") as inf:
            ...
            try:
                ...
                print(f"CSV parsing error in {csv_file}: {e}", file=sys.stderr)
                continue
            #####
...
def main():
    ...
    parser.add_argument("--output-dir", default="data/reference-free_metrics/clarity", help="Directory to write outputs")
